    ...
    render() {
        const onSuccess = (payment) => {
            // Congratulations, it came here means everything's fine!
                    ...
                    this.props.history.push('/');//directing the user back to the home page after successful shopping
        ...
        const client = {
            sandbox: "AZXOkYjUVMwdn_nGG6s8uXJPhcpmK2B5eWw6n2S-hxEfZ72e_zUM2regDPoDrUt6fstKpNwY9F3AvTjj",
